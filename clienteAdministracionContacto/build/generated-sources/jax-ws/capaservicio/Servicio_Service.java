 ...
 * 
 */
@WebServiceClient(name = "Servicio", targetNamespace = "http://capaServicio/", wsdlLocation = "http://localhost:8080/ServicioadministracionContacto/Servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://capaServicio/", "Servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioadministracionContacto/Servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://capaServicio/", "ServicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://capaServicio/", "ServicioPort"), Servicio.class, features);
    }
