<%-- 
    ...
    Created on : 10-may-2016, 22:42:36
    Author     : Adrian
--%>
                    ...
                    <center> 
                        <div class="row"> 
                            <div class="col-sm-12"> 
                                <center>
                                    <h2>
                                        <b class="letra"> Eliminar Contacto</b>
                                    </h2>
                                </center>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" name="uidContacto" placeholder="uid del contacto" class="form-control" id="uidContacto" pattern="[0-9]{1,}" />
                                </div>
                            </div>
                        </div>
                    </center>
