<%-- 
    Document   : buscarContactosNotificaciones
    Created on : 04-jul-2016, 23:01:03
    Author     : Adrian
--%>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
    ...
    <div  class="container" >
        ...
        <div class="row" >
            <center>
                <h2 >
                    <b class="letra">Busqueda Contactos Notificacion Leida</b>
                </h2>
            </center>
        </div>
    <center>
        <form class="form-inline" method="post" action="Notificacionleida"
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <div class="col-sm-7">
                            <input type="text" placeholder="uid de notificacion" class="form-control" id="textoBusqueda"
                                   name="uidNotificacion" pattern="[0-9]{1,20}" required>
                        </div>
                        <<div class="row" >
                            <div class="col-sm-12"> 
